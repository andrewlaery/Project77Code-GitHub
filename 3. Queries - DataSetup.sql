...
DROP TEMPORARY TABLE IF EXISTS TTX_RECORDS_PROJECTS2;
CREATE TEMPORARY TABLE TTX_RECORDS_PROJECTS2 AS
	SELECT *
...
DROP TEMPORARY TABLE IF EXISTS TTX_CURRENTMEMBERS0;
CREATE TEMPORARY TABLE TTX_CURRENTMEMBERS0 AS
    SELECT
        CONCAT(RECORDS_MEMBERS.namefirst , ' ' , RECORDS_MEMBERS.namelast) AS NameFull ,
        currentclubs ,
        currentmember
...
DROP TEMPORARY TABLE IF EXISTS TTX_CONTESTABLE_TMIROLES_TO_MEMBERS2;
CREATE TEMPORARY TABLE TTX_CONTESTABLE_TMIROLES_TO_MEMBERS2 AS
    SELECT *
