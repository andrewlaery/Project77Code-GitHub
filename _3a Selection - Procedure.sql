...
BEGIN
	...
	INSERT INTO TX_RECORDS_MEMBER_AVAILABLE1
		...
		WHERE
			...
			AND (MembersID NOT IN (SELECT MembersID FROM TX_RECORDS_MEMBER_UNAVAILABILITY1));
	...
	INSERT INTO TX_MOSTRECENTROLE_ALLRANK0
		...
		LEFT JOIN TX_MOSTRECENTROLE1 ON CONCAT(TX_MOSTRECENTROLE1.MembersID, ' - ' , Role) = CONCAT(TX_CURRENTMEMBERS1.MembersID, ' - ' , @Role1)
	...
	INSERT INTO TX_MOSTRECENTROLE_AVAILABLERANK0
		...
		LEFT JOIN TX_MOSTRECENTROLE_ALLRANK0 ON TX_MOSTRECENTROLE_ALLRANK0.MembersID = TX_RECORDS_MEMBER_AVAILABLE1.MembersID
		ORDER BY DateToRank , NameFull;
